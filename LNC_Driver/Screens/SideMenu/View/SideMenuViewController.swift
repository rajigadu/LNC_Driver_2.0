...
class SideMenuViewController: UIViewController {
    ...
    var arrayResponse = ["Home","Driver Type","Ride Reservations","Accepted Rides","DBH-Assign Rides","Manage Partners","DBH-Ride History","Ride History","Payment History","Weekly Payments","My Rewards","Settings","Employee Guidelines","Logout"];//@"Future Ride Info",@"Future Ride History","Trany Videos"
...
extension SideMenuViewController :UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        } else if arrayResponse[indexPath.row] == "DBH-Ride History" {
