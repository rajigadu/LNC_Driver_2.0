...
typealias RideReservationsData = RideReservationsModel

struct RideReservationsModel : Codable {
    let data : [RideReservationsDatar]?
    let status : String?
    let message : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([RideReservationsDatar].self, forKey: .data)
        status = try values.decodeIfPresent(String.self, forKey: .status)
        message = try values.decodeIfPresent(String.self, forKey: .message)
    }

}
struct RideReservationsDatar : Codable {
    let message: String?
    let id : String?
    let user_id : String?
    let card_id : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        distances = try values.decodeIfPresent(String.self, forKey: .distances)
    }
...
typealias AcceptedRideReservationsData = AcceptedRideReservationsModel

struct AcceptedRideReservationsModel : Codable {
    let status : String?
    let message : String?
...
// Driver Accepted with time bases

typealias AlereadyAcceptedridetimebasesData = AlereadyAcceptedridetimebasesModel

struct AlereadyAcceptedridetimebasesModel : Codable {
    let message : String?
    let status : String?
    let data : [AlereadyAcceptedridetimebasesDatar]?
    ...
    init(from decoder: Decoder) throws {
        ...
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
        data = try values.decodeIfPresent([AlereadyAcceptedridetimebasesDatar].self, forKey: .data)
    }

}

struct AlereadyAcceptedridetimebasesDatar : Codable {
    let id : String?
    let user_id : String?
    let card_id : String?
    let numstops : String?
